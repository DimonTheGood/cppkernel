...
CPP_SRC := src/kernel.cpp src/serial.cpp src/frame_allocator.cpp src/libc.cpp src/gdt.cpp src/idt.cpp src/ports.cpp src/pic.cpp src/pit.cpp src/paging.cpp src/heap.cpp
